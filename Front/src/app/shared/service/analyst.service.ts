...
export class AnalystService {
  ...
  Consultaconfirmaranalyst(form: any,user:User): Observable<any> {
    this.API_SERVER = environment.URL_BASE + 'multiplo/analista/consultas/transacciones/porConciliar';
    const headers: any ={
  ...
  ConsultadatosdePago(form: any,user:User): Observable<any> {
    this.API_SERVER = environment.URL_BASE + 'multiplo/consultas/transacciones';
    const headers: any = {
      "Authorization": 'Bearer ' +user.token
   };
   console.log(form)
   let formData = new FormData();
   formData.append('numSol', form.numeroSolicitud);
   //Post options pass it to HttpHeaders Class 
    const httpOptions = {
       headers: new HttpHeaders(headers),
   };
...
//generacion/validar/proyecto
validarProyecto(form: any,user:User): Observable<any> {
  this.API_SERVER = environment.URL_BASE + 'multiplo/generacion/validar/proyecto';
  const headers: any = {
    "Authorization": 'Bearer ' +user.token
  };
 ...
 //Post options pass it to HttpHeaders Class 
  ...
  ConsultaFirmaContratoanalyst(form: any,user:User): Observable<any> {
    this.API_SERVER = environment.URL_BASE + 'multiplo/analista/consultas/proyectos/enFirma/filter';
    const headers: any = {
      "Authorization": 'Bearer ' +user.token
    };
   //Post options pass it to HttpHeaders Class 
    ...
    ConsultaVigenteAgrupadas(form: any,user:User): Observable<any> {
      this.API_SERVER = environment.URL_BASE + 'multiplo/analista/consultas/proyectos/exitoso/filter';
      const headers: any = {
        "Authorization": 'Bearer ' +user.token
      };
      const httpOptions = {
      ...
      if(form.codProyecto){
        const formData = new FormData();
        formData.append('codProyect', form.codProyecto);
         return this.http.post(this.API_SERVER, formData,httpOptions).pipe(
        catchError(this.handleError)
      );
      }
  ...
  //analista/consultas/solicitud/liquidada/filter
  ConsultaLiquidadas(form: any,user:User): Observable<any> {
    this.API_SERVER = environment.URL_BASE + 'multiplo/analista/consultas/solicitud/liquidada/filter';
    const headers: any = {
      "Authorization": 'Bearer ' +user.token
    };
    console.log(form)
  ...
  ConsultaCanceladas(form: any,user:User): Observable<any> {
    this.API_SERVER = environment.URL_BASE + 'multiplo/analista/consultas/solicitud/anulada/filter';
    const headers: any = {
      "Authorization": 'Bearer ' +user.token
    };
    console.log(form)
  ...
  Consultaprobadoporaconfirmaranalyst(form: any,user:User): Observable<any> {
    this.API_SERVER = environment.URL_BASE + 'multiplo/analista/consultas/proyectos/aprobadasTF/filter';//
    const headers: any = {
      "Authorization": 'Bearer ' +user.token
   };
  ...
  subirExcelService(datos: any,files:File,user: User){
    this.API_SERVER = environment.URL_BASE + 'multiplo/analista/conciliaciones/EstadoCuenta/upload';
    const headers: any = {
      "Authorization": 'Bearer ' +user.token
   };
  ...
  consultarExcelData(user: User){
    this.API_SERVER = environment.URL_BASE + 'multiplo/analista/conciliaciones/consultarDatos';
    const headers: any = {
      "Authorization": 'Bearer ' +user.token
   };
   //Post options pass it to HttpHeaders Class 
  ...
  conciliarExcelData(user: User){
    this.API_SERVER = environment.URL_BASE + 'multiplo/analista/conciliaciones/conciliarDatos';
    const headers: any = {
      "Authorization": 'Bearer ' +user.token
   };
   //Post options pass it to HttpHeaders Class 
  ...
  GuardarConciliacion(user: User){
    this.API_SERVER = environment.URL_BASE + 'multiplo/analista/conciliaciones/aprobarDatos';
    const headers: any = {
      "Authorization": 'Bearer ' +user.token
   };
   //Post options pass it to HttpHeaders Class 
  ...
  analystValidDetails(form: any,user:User): Observable<any> {
    this.API_SERVER = environment.URL_BASE + 'multiplo/analista/consultas/solicitud/por/proyecto/vigente';
    const headers: any = {
      "Authorization": 'Bearer ' +user.token
   };
   console.log(form)
  ...
  analystSignDetails(form: any,user:User): Observable<any> {
    this.API_SERVER = environment.URL_BASE + 'multiplo/analista/consultas/solicitud/enFirma/porProyecto';
    const headers: any = {
      "Authorization": 'Bearer ' +user.token
   };
   const formData = new FormData();
  ...
  analystAprobadaDetails(form: any,user:User): Observable<any> {
    this.API_SERVER = environment.URL_BASE + 'multiplo/analista/consultas/solicitud/aprobadaPorTransferir/porProyecto';
    const headers: any = {
      "Authorization": 'Bearer ' +user.token
   };
   console.log(form)
  ...
  /*GuardarConciliacion(datos: any,files:File,user: User): Observable<any>{
    const headers: any = {
      "Authorization": 'Bearer ' +user.token
   };
   const formData = new FormData();
   formData.append('conciliacion', JSON.stringify(datos));
   formData.append('file',files);
    const httpOptions = {
       headers: new HttpHeaders(headers),
   };
    console.log(datos);
    this.API_SERVER = environment.URL_BASE + 'multiplo/conciliaciones/documentos/upload';
  ...
  aprobarSolicitudesaFirmaContrato(codProyect: any,user: User): Observable<any>{
   ...
   formData.append('usuarioInterno',user.user.identificacion);
    const httpOptions = {
       headers: new HttpHeaders(headers),
   };
  ...
  tranferirFondos(form: any,file:File,user: User): Observable<any>{
   ...
   formData.append('observacion',form.observacion);
    ...
    this.API_SERVER = environment.URL_BASE + 'multiplo/analista/procesos/transferirFondos';
    return this.http.post<any>(this.API_SERVER,formData,httpOptions).pipe(
      catchError(this.handleError)
    );
  }
  ...
  registrarPagoInversionista(form: any,file:File,user: User): Observable<any>{
   ...
   formData.append('usuarioModificacion',form.usuarioModificacion);
    const httpOptions = {
       headers: new HttpHeaders(headers),
   };
    this.API_SERVER = environment.URL_BASE + 'multiplo/analista/procesos/registrarPagos/vigentes';
    return this.http.post<any>(this.API_SERVER,formData,httpOptions).pipe(
      catchError(this.handleError)
    );
  }
