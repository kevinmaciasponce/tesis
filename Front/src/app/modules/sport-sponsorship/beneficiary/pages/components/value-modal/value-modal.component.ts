...
export class ValueModalComponent implements OnInit, OnDestroy {
  ...
  constructor(private sanitizer: DomSanitizer,
    ...
    private activeModal:NgbActiveModal
      ...
      if(this.get_data('identBeneficiario')){
  ...
  ngOnDestroy(): void {
    localStorage.removeItem('identBeneficiario');
 ...
 onSubmit() {
  ...
  consultarValoracion(){
    console.table(this.obtenerDatos());
    this.beneficiario.consultarValoracion(this.get_data('identBeneficiario')as string,this.user).subscribe( 
      (data:any)=>{
        console.table(data);
  ...
  obtenerDatos(){
    ...
    if(this.get_data('identBeneficiario')){
      valoracion = {
        "idBene":this.get_data('identBeneficiario')as string,
        ...valoracion,
      }
    }else if(this.get_data('cedula')){
      valoracion = {
        "idBene":this.get_data('cedula')as string,
        ...valoracion,
      }
    }
    return valoracion;
  ...
  existeValoracion():boolean{
    this.beneficiario.validaValoracion(this.get_data('identBeneficiario')as string,this.user).subscribe( 
      (data:any)=>{
        console.log(data);
